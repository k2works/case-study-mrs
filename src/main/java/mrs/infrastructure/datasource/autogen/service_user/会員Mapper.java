package mrs.infrastructure.datasource.autogen.service_user;

import mrs.domain.model.autogen.service_user.会員;
import org.apache.ibatis.annotations.*;

public interface 会員Mapper {
    /**
     * This method was generated by MyBatis Generator.
     * This method corresponds to the database table service_user.会員
     *
     * @mbg.generated
     */
    @Delete({
            "delete from service_user.会員",
     ...
     */
    @Insert({
            "insert into service_user.会員 (会員番号, 姓, ",
            "名, パスワード, 役割, ",
            "登録日時)",
    ...
    @ResultMap("mrs.infrastructure.datasource.autogen.service_user.会員Mapper.BaseResultMap")
